...
### 👑 Arif Nur Fatahillah (Lead Project Manager & Integrator)
* **Kontribusi:** Bertanggung jawab penuh atas manajemen *repository* kelompok, penataan hak akses dan keamanan *branch* utama via *GitHub Ruleset*, penyelesaian *code conflict*, serta melakukan *review* dan persetujuan akhir (*Merge Pull Request*) kode tim. *(Non-Coding Fitur)*.
